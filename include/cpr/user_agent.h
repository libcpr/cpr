...
class UserAgent : public StringHolder<UserAgent> {
  public:
    ...
    explicit UserAgent(const std::string& useragent) : StringHolder<UserAgent>(useragent) {}
    explicit UserAgent(const std::string&& useragent)
            : StringHolder<UserAgent>(std::move(useragent)) {}
    explicit UserAgent(const char* useragent) : StringHolder<UserAgent>(useragent) {}
