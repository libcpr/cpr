...
class HttpServer : public AbstractServer {
  ...
  private:
    ...
    static void OnRequestLowSpeedTimeout(mg_connection* conn, mg_http_message* msg);
    static void OnRequestLowSpeed(mg_connection* conn, mg_http_message* msg);
    static void OnRequestLowSpeedBytes(mg_connection* conn, mg_http_message* msg);
    ...
    static void OnRequestCheckCookies(mg_connection* conn, mg_http_message* msg);
    static void OnRequestV1Cookies(mg_connection* conn, mg_http_message* msg);
    static void OnRequestCheckV1Cookies(mg_connection* conn, mg_http_message* msg);
    ...
    static void OnRequestReflectPost(mg_connection* conn, mg_http_message* msg);
